      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <h3 className="text-3xl font-black text-white tracking-tight flex gap-2">
              {/* ✨ THE PREMIUM SHEEN EFFECT ✨ */}
              <motion.span
                className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-white via-teal-300 to-white bg-[length:200%_auto]"
        ...
        <motion.div 
          ...
          className="mb-8 p-5 bg-slate-900/50 border border-slate-800 rounded-xl flex items-start gap-4 text-slate-400 shadow-inner"
        >
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-slate-500 font-medium">
          ...
          <p className="mt-4 md:mt-0 flex items-center gap-2 text-sm">
            ...
            <motion.span 
              ...
              className="text-teal-500 font-black tracking-wider hover:text-teal-300 hover:drop-shadow-[0_0_8px_rgba(45,212,191,0.6)] transition-all cursor-pointer"
            >
              NexusNode
            </motion.span>
          </p>
