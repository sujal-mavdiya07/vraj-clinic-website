...
// NOTE: Metadata remains in app/about/layout.tsx for SEO purposes!
    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="bg-teal-900 text-white py-20 relative overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-0 right-1/4 w-96 h-96 bg-teal-800 rounded-full blur-[80px] pointer-events-none"
        ></motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <motion.p 
            ...
            className="text-xl text-teal-100 max-w-2xl mx-auto leading-relaxed"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-start">
          ...
          >
            <div className="relative group w-72 h-96 md:w-80 md:h-[450px]">
              ...
              <motion.div 
                ...
                className="absolute inset-0 bg-gray-200 rounded-3xl border-4 border-white shadow-xl flex items-center justify-center overflow-hidden z-10 text-center"
              >
                <img 
                  src={doctorImage} 
            ...
            <motion.div 
              ...
              className="mt-12 bg-teal-50 w-full rounded-2xl p-6 border border-teal-100 text-center shadow-sm hover:shadow-md transition-shadow"
            >
              ...
              <motion.div 
                ...
                className="h-1 bg-teal-300 mx-auto mt-4 rounded-full"
              ></motion.div>
            </motion.div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="w-full lg:w-2/3 space-y-8 text-lg text-gray-700 leading-relaxed"
          >
            ...
            <motion.div 
              ...
              className="bg-white border-l-4 border-teal-500 pl-6 py-4 my-8 italic text-xl text-gray-800 shadow-sm rounded-r-lg"
            >
            ...
            <p className="text-gray-900">
              Over the years, I have successfully treated a wide variety of chronic and acute conditions, with a special focus on <strong className="text-teal-800">women's health, pediatric care, skin disorders, and respiratory issues</strong>. My approach is compassionate and thorough. When you visit my clinic, you are not just a patient file; we take the time to listen to your entire health history to find the exact remedy that will stimulate your body's own natural healing abilities.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="bg-slate-50 py-20 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Value 1 */}
            <motion.div variants={popUpCard} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100 text-center group">
              <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className="w-16 h-16 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center text-3xl mx-auto mb-6">🌱</motion.div>
            ...
            {/* Value 3 */}
            <motion.div variants={popUpCard} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100 text-center group">
              <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className="w-16 h-16 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center text-3xl mx-auto mb-6">🛡️</motion.div>
      ...
      <div className="bg-teal-600 py-16">
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link href="/contact" className="inline-block bg-white text-teal-700 font-bold text-lg px-8 py-4 rounded-full shadow-lg hover:shadow-xl hover:bg-teal-50 transition-colors duration-300">
